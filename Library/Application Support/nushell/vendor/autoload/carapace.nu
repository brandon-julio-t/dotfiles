$env.PATH = ($env.PATH | split row (char esep) | where { $in != "/Users/brandonthenaro/Library/Application Support/carapace/bin" } | prepend "/Users/brandonthenaro/Library/Application Support/carapace/bin")
