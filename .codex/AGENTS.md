...
- Keep each review subagent prompt atomic and small. Review the smallest coherent diff slice; for broader work, split the diff aggressively and spawn as many focused review subagents as practical across disjoint files or areas.
